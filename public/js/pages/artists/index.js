...
/***/ "./resources/assets/js/pages/artists/index.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    data: {
        drawer: false,
        filter: '',
        allArtists: [{ name: 'Droeloe', miscCount: 5, path: '#' }, { name: 'Illenium', miscCount: 3, path: '#' }],
        showArtists: []
    },
    methods: {
        LinkToArtist: function LinkToArtist(name) {
    ...
    computed: {
        ...
        filteredArtists: function filteredArtists() {
            ...
            if (this.filter.length > 0) {
                var a = [];
                this.allArtists.forEach(function (entity) {
