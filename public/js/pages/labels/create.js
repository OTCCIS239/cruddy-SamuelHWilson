...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\",[\"transform-runtime\",{\"polyfill\":false,\"helpers\":false}]]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/assets/js/components/tracks/TracksSelect.vue":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-06e027de\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/assets/js/components/tracks/TracksSelect.vue":
/***/ (function(module, exports, __webpack_require__) {
  ...
  return _c(
    ...
    [
      _c("v-select", {
        ...
        on: { change: _vm.AddTrack }
      }),
      _vm._v(" "),
      _c("v-tracks-summary", {
        attrs: {
          size: _vm.size,
          tracks: _vm.selectedTracks,
          actionIcon: "trash",
          actionEvent: "remove-track"
        },
        on: { "remove-track": _vm.RemoveTrack }
      })
    ],
    1
  )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-06e027de", module.exports)
  }
}
...
/***/ "./resources/assets/js/components/tracks/TracksSelect.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var __vue_script__ = __webpack_require__("./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\",[\"transform-runtime\",{\"polyfill\":false,\"helpers\":false}]]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/assets/js/components/tracks/TracksSelect.vue")
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-06e027de\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/assets/js/components/tracks/TracksSelect.vue")
/* template functional */
var __vue_template_functional__ = false
/* styles */
var __vue_styles__ = null
...
Component.options.__file = "resources\\assets\\js\\components\\tracks\\TracksSelect.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-06e027de", Component.options)
  } else {
    hotAPI.reload("data-v-06e027de", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('v-tracks-select', __webpack_require__("./resources/assets/js/components/tracks/TracksSelect.vue"));
...
var app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    methods: {
        ...
        HandleChangedArtists: function HandleChangedArtists(selectedArtists) {
            this.selectedArtists = selectedArtists.join('s');
        },
        HandleChangedTracks: function HandleChangedTracks(selectedTracks) {
            this.selectedTracks = selectedTracks.join('s');
        },
        DBAddLabel: function DBAddLabel(selectedTracks) {
    ...
    mounted: function mounted() {
        ...
        this.$http.get('/api/artists/list/summary').then(function (response) {
            _this.searchableArtists = response.body;
        }, function (response) {});
        this.$http.get('/api/tracks/list/').then(function (response) {
            _this.searchableTracks = response.body;
        }, function (response) {});
    }
});
