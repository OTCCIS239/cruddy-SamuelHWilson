...
var app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    mounted: function mounted() {
        ...
        this.$http.get('/api/labels/show/' + mainID).then(function (response) {
            _this.name = response.body.name;
            _this.signedArtists = response.body.artists;
            _this.publishedTracks = response.body.tracks;
        }, function (response) {
            console.log("Arghhh!");
        });
    }
